...
| `HERMES_QUANT_OPTIONS_EVIDENCE_GATE` | `0` | `hermes_quant/autonomous.py:2351` |
...
| `HERMES_QUANT_OPTIONS_PERCEIVE` | `0` | `hermes_quant/autonomous.py:2387` |
...
| `HERMES_QUANT_PER_POSITION_STOP` | `0` | `hermes_quant/autonomous.py:2079` |
...
| `HERMES_QUANT_PORTFOLIO_CAPS` | `` | `hermes_quant/autonomous.py:2158` |
...
| `HERMES_QUANT_TAKE_PROFIT_SWEEP` | `0` | `hermes_quant/autonomous.py:1651` |
...
| `HERMES_QUANT_TP_TRANCHE` | `0` | `hermes_quant/autonomous.py:1660` |
...
| `HERMES_QUANT_WATCH_REGISTRY` | `0` | `hermes_quant/autonomous.py:1669` |
