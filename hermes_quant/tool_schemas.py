...
QUANT_SHOW_SIGNALS = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "asset": {"type": "string", "description": "Optional asset filter (e.g. 'BTC/USDT')"},
            "direction": {
                "type": "string",
                "enum": ["long", "short", "flat", "any"],
                "default": "any",
            },
        },
        "required": [],
...
QUANT_SHOW_VIEWS = {
    ...
    "parameters": {
        "type": "object",
        "properties": {
            "asset": {"type": "string", "description": "Asset to inspect (e.g. 'BTC/USDT')"},
            "analyst": {"type": "string", "description": "Optional analyst name filter"},
            "n": {"type": "integer", "default": 10, "description": "Max views per analyst"},
        },
        "required": ["asset"],
    },
}
...
QUANT_PENDING = {
    "name": "quant_pending",
    "description": "List currently-pending proposals (sweeps expired ones first). Read-only.",
    "parameters": {
        "type": "object",
        "properties": {
...
QUANT_WATCHLIST_ADD = {
    ...
    "parameters": {
        "type": "object",
        "properties": {
            "symbol": {"type": "string", "description": "Ticker or pair (e.g. 'AAPL', 'BTC/USDT')"},
            "asset_class": {
                "type": "string",
                "enum": ["equity", "etf", "crypto", "fx"],
                "default": "equity",
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "asset_class": {
                "type": "string",
                "enum": ["equity", "etf", "crypto", "fx"],
                "description": "Optional; if set, only remove entries matching this asset_class",
            },
        },
        "required": ["symbol"],
    },
