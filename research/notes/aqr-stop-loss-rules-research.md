---
title: AQR Stop-Loss Rules Research
id: aqr-stop-loss-rules-research
tags:
- stop-loss
...
deprecated: false
summary: 'AQR-style view: per-position stops are a blunt instrument vs volatility-targeting
  (size smaller at entry on high-vol names rather than install a fixed stop); but
  a hard stop remains the simplest tail-protection for a thin-history book.'
---
