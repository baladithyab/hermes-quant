---
title: Optimal Stop-Loss
id: optimal-stop-loss
tags:
- stop-loss
...
deprecated: false
summary: 'Overview of optimal stop placement: stop distance should scale with instrument
  volatility; too-tight stops (< ~1 daily-sigma) churn on noise; placement is a joint
  problem with the take-profit / holding horizon.'
---

Why Does Stock Market Volatility Change Over Time? | NBER
...
Copy Citation
G. William Schwert, "Why Does Stock Market Volatility Change Over Time?," NBER Working Paper 2798 (1988), https://doi.org/10.3386/w2798.
Copy to Clipboard
Download Citation
MARC
RIS
...
The
Journal of Finance
, Vol. XLIV, No. 5, pp. 1115-1153, (December 1989).
